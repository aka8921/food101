...
export const Login = () => {
    ...
    return(
        <div className="flex flex-col items-center justify-center h-screen gap-[20px]" style={{background: "radial-gradient(114.91% 40.16% at 50% 0%, #4160E0 0%, rgba(179, 141, 246, 0.1) 100%)"}}>
            {/* TOP_SECTION */}
            ...
            {/* FORM_SECTION */}
            <div className="w-[400px] flex flex-col gap-4 items-center justify-center relative mx-10 overflow-hidden">
                <h1 className='text-[30px] font-bold'>Sign In - Admin</h1>
            ...
            {/* Button */}
                <GradientButton
                className="mt-auto w-[400px] gap-2 text-white flex items-center justify-center m-5"
