...
export const MealCard = ({balance}) => {
    return (
        <div className="relative flex items-center justify-center">
            ...
            className="z-20 my-4 px-5 py-5 text-white relative w-full min-h-[100px] rounded-2xl flex flex-col items-start justify-between overflow-hidden" 
            >
            ...
            <div
            style={{background: "linear-gradient(252.22deg, #E09EFF 0%, #385CDE 99.1%)"}} 
            className="z-1 opacity-40 absolute  bottom-[-8px] my-4 px-5 py-5 text-white w-[90%] h-[100px] rounded-2xl flex flex-col items-start justify-between overflow-hidden" 
            ></div>
            <div
            style={{background: "linear-gradient(252.22deg, #E09EFF 0%, #385CDE 99.1%)"}} 
            className="z-10 opacity-10 absolute  bottom-[-15px] my-4 px-5 py-5 text-white w-[80%] h-[100px] rounded-2xl flex flex-col items-start justify-between overflow-hidden" 
            ></div>
        </div>
